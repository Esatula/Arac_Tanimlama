...
python3 -m plaka_motoru.data_modules.numberplate_orientation_data_module -f plaka_motoru/data_modules/numberplate_orientation_data_module.py
"""
from plaka_motoru.data_loaders import ImgOrientationGenerator
...
if __name__ == "__main__":
    ...
    for batch in test_loader:
        print(batch)  # Çeviriіrka vmіstu butch
