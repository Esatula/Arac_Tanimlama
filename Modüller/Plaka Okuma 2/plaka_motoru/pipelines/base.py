...
from plaka_motoru.tools import promise_all
from plaka_motoru.tools import chunked_iterable
from plaka_motoru.image_loaders import BaseImageLoader, DumpyImageLoader, image_loaders_map
...
# Sözlük yardımcısıіKiril sembolü için nів
cyrillic_to_latin = {
    'А': 'A', 
    'І': 'I',
    'В': 'B', 
...
def replace_cyrillic(text):
    # Milletvekiliіняєek kelime dağarcığı için mo kozhen sembolü
...
class AccuracyTestPipeline(object):
    ...
    def text_accuracy_test(true_images_texts, predicted_images_texts,
        ...
        """
        import shutil
        bad_images_path = "/var/www/plaka-net/data/examples/2lines_via_2021_06_14/bad_images"
        n_good = 0
        n_bad = 0
