...
from plaka_motoru.image_loaders import BaseImageLoader
from plaka_motoru.pipelines.base import Pipeline, CompositePipeline, empty_method
...
from plaka_motoru.tools.image_processing import (crop_number_plate_zones_from_images,
