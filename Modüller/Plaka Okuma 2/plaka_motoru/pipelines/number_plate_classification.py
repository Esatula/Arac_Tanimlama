...
python3 -m plaka_motoru.pipelines.number_plate_classification -f plaka_motoru/pipelines/number_plate_classification.py
"""
from torch import no_grad
from typing import Any, Dict, Optional, Union
from plaka_motoru.image_loaders import BaseImageLoader
from plaka_motoru.pipelines.base import Pipeline
