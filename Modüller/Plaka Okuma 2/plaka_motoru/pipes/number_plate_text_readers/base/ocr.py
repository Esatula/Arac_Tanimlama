"""
python3 -m plaka_motoru.pipes.number_plate_text_readers.base.ocr -f plaka_motoru/text_detectors/base/ocr.py
"""
import os
import io
import cv2
...
from plaka_motoru.data_modules.numberplate_ocr_data_module import OcrNetDataModule
from plaka_motoru.nnmodels.ocr_model import NPOcrNet, weights_init

from plaka_motoru.tools.image_processing import normalize_img
from plaka_motoru.tools.errors import OCRError
from plaka_motoru.tools.mcm import modelhub, get_device_torch
from plaka_motoru.tools.augmentations import aug_seed
from plaka_motoru.tools.ocr_tools import (StrLabelConverter,
                                          decode_prediction,
                                          decode_batch)
