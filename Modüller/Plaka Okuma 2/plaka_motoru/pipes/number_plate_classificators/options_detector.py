...
from plaka_motoru.nnmodels.numberplate_options_model import NPOptionsNet
from plaka_motoru.tools.image_processing import normalize_img, convert_cv_zones_rgb_to_bgr
