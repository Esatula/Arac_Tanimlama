"""
python3 -m plaka_motoru.pipes.number_plate_classificators.options_detector_trt \
        -f plaka_motoru/pipes/number_plate_classificators/options_detector_trt.py
"""
import os
import cv2
...
from plaka_motoru.tools import modelhub
from plaka_motoru.tools.cuda_primary_context import primary_cuda_context
from plaka_motoru.pipes.number_plate_classificators.options_detector import OptionsDetector
